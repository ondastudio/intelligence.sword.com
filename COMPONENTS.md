...
| CircleButton | `ui/CircleButton.astro` | `href`, `label`, `class` | 132px circular dashed button with a downward arrow. |

## Layout — `src/components/layout/`

| Component | Path | Props | Description |
| --------- | ---- | ----- | ----------- |
| Logo | `layout/Logo.astro` | `href`, `class` | "sword \| Intelligence" wordmark (text). Reads `data/site.json`. |
